...
namespace WeeklyTids_CSV
{
    public partial class Program
    {
        ...
        public static string connectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + OutputDirectory + "VERICENTRE.xlsx;Extended Properties='Excel 12.0 Xml;HDR=YES;';";
        ...
        static void Main(string[] args)
        {
            ...
            System.IO.File.Delete(@"\\GRAT1-FPS-SV2O\Common\Users\PDS_TMS_Reports\VERICENTRE.xlsx");
...
//            swra.Start();
            ...
            // Check for table [vc30offline].[vc30].[tmp_Tms] if exists so to create or not
            bool isExists;
